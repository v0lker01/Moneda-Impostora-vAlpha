class Escena4 extends Phaser.Scene {
    ...
    create ()
    {
        ...
        platforms.create(600, 400, 'PlataformaA');
        platforms.create(500, 220, 'PlataformaA');

        MovingPlatform = this.physics.add.image(75, 250, "PlataformaA");
        ...
        this.physics.add.overlap(player, MonedaD, this.JuntarMonedaB, null, this);
